...
import { AlertTriangle, Download, Wallet, CheckCircle, XCircle, RefreshCw } from 'lucide-react';
import { useWallet } from '../hooks/useWallet';
import { showWalletInstallPrompt } from '../services/walletService';
            ...
            <div className="flex-1">
              ...
              <div className="flex gap-2">
                <button
                  ...
                  className="inline-flex items-center px-3 py-2 text-sm font-medium text-amber-900 bg-amber-100 border border-amber-300 rounded-md hover:bg-amber-200 focus:outline-none focus:ring-2 focus:ring-amber-500 focus:ring-offset-2 transition-colors"
                >
                ...
                <button
                  ...
                  className="inline-flex items-center px-3 py-2 text-sm font-medium text-amber-700 bg-transparent border border-amber-300 rounded-md hover:bg-amber-50 focus:outline-none focus:ring-2 focus:ring-amber-500 focus:ring-offset-2 transition-colors"
                >
